<template>
    <div class="container mx-auto px-5 mt-5">
        <div class="flex">
            <div class="text-3xl mb-5">Edit User Form</div>
            <div>
                <Link href="/users"
                    class="inline-block text-white bg-gray-600 hover:bg-gray-700 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 ml-4">
                Back</Link>
            </div>
        </div>
...
const { user } = defineProps({ user: Object, errors: Object })
